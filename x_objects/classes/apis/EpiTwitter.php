...
class EpiTwitter extends EpiOAuth
{
  ...
  public function __call($name, $params = null/*, $username, $password*/)
  {
	...
	/*
	 * we need to log calls to twitter oauth for performance statistics
	 * 
	 */
	 global $container;
	 if ( $name =='get_accountVerify_credentials'){
	 	$container->apis->twitter->log_oauth_call();
	 }
...
class EpiTwitterException extends Exception 
{
  ...
  {
//  	echo "throwing exception with message".$response;
